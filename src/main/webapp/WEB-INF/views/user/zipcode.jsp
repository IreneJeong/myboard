...
function setZipcode(zip1,zip2,addr1){
	...
	//opener.document.regist.zipcode.value=zip1+'-'+zip2;
		...
		<c:if test="${zipcodeList != null}">
			<c:forEach items="${zipcodeList}" var="vo"> 
				<tr>
					<td width="65">
						<a href="javascript:;"
						 onclick="setZipcode('${vo.zipcode1}','${vo.zipcode2}','${vo.address1}')">${vo.zipcode1}-${vo.zipcode2}</a>
					</td>
					<td>${vo.address1}</td>
				</tr>
			</c:forEach>
